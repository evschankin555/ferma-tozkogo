...
Ext.extend(catalogfill.panel.Home,MODx.Panel,{
    ...
    */
    ...
    ,editConfigFile: function(btn,e){
        ...
        var core_path_arr = MODx.config.core_path.split('/');
        var core_url = core_path_arr[(core_path_arr.length-2)];
        ...
        if(config_name == ''){
            ...
            window.open( MODx.config.manager_url+'?a=system/file/edit&file='+core_url+'/components/catalogfill/config/'+config_name+'.php&source=1', '_blank' );
        }
